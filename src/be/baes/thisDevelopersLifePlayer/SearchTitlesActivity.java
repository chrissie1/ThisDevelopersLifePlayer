...
public class SearchTitlesActivity extends RoboActivity implements Observer{
    ...
    @Inject
    be.baes.thisDevelopersLifePlayer.controllers.OnPodCastItemListClickListener onPodCastItemListClickListener;
    @Inject
    ...
    @Inject
    OnDetailsFromSearchClickListener onDetailsClickListener;
    @Inject
    ...
    @Inject
    OnFlingSearchOnTouchListener onFlingSearchOnTouchListener;
    @Inject
