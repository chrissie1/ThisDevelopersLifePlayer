...
public class Constants {
    public static final String LOG_ID = "cbaes.thisDeveloperslife";
    ...
    public static final String DATABASE_NAME = "thisdeveloperslife";
    ...
    public static final String PREFIX = "http://feedproxy.google.com/~r/ThisDevelopersLife/~3/";
    public static final String urlToRssFeedAll = "http://feeds.feedburner.com/thisdeveloperslife?format=xml";
    public static final String urlToRssFeedLatest = "http://feeds.feedburner.com/thisdeveloperslife?format=xml";
    ...
    public static final String HANSELMINUTESPLAYER_ACTIVITY = "ThisDeveloperLifePlayerActivity";
